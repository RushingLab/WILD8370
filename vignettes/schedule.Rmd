...
schedule <- data.frame(WK = c("1", "", "", 
      ...
      "Introduction to Linear Models and Nimble", "Introduction to Linear Models and Nimble", "", #4
      "Random/fixed effects in linear models", "Informative Priors", "", #5
      "Observation error, intro to hierarchical models", "Observation error, intro to hierarchical models", "", #6
      "Estimating occupancy from presence/absence data", "Estimating occupancy from presence/absence data", "", #7
      "", "", "", #8 

...
-   what day each location was measured (day 1 to day 30)
...
Simulate some data based on the above model. Use $\sigma = .5$. Store the results as a 3-d array or matrix (10 by 2 by 50)

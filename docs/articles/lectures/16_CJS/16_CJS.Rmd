...
cjs2 <- nimbleCode({
  for(i in 1:nind){
    y[i, first[i]:nocc] ~ dCJS_vs(probSurvive = phi, 
...
Researchers from USGS have been capturing and marking frogs and toads in Wyoming and Montana since 2001 to research survival in response to chytrid fungus (*Batrachochytrium dendrobatidis*). 
